...
public class TC_ytp extends Base_Class {
	...
	public void verify_ytp_journey(
			...
			String Mobile_Number, String Gender, String Dob, String consume_tobacco, String occu, String edu,
			String annualIncome, String Emp,
			// Sum Assured
			String sum, String policy_term, String pay, String Payment_Term, String rop,
			// Life Secure
			...
			String adhar, String fatherName, String middleName, String lastName, String motherName, String middleName1,
			String lastName1, String martialStatus, String mobileNum, String politically_Exposed_Person,
			String Person_Exposed_Politically, String Relation_With_Person, String Source_Of_Income,
			String Name_Of_Political_Party, String Role_Of_Person, String Any_Crminial_Case, String criminal_Charges,
			String ageProof, String VP_num, String Vp_Exp_Date, String VID_4digit, String VDL_Num, String VDL_Exp_date,
			String IdProof, String VP_Id_Proof_Num, String VP_Id_Proof_Exp_Date, String VID_Id_Proof_4digit,
			String NREGA, String VDL_Id_Proof_Num, String VDL_Exp_Date, String Voter_Id,

			// Proposal [ Professional Detail ]
			String Orgnization_Name, String pincode_zip, String state_List, String adress, String Orgnization_City,
			String Nature_OF_Duty, String Exact_Nature_OF_Duty, String Provide_Detail, String Exact_Nature_Of_Job_Title,
			String Percentage_Of_Duties_Manual, String typeOfVesselWork, String DateOfEntry, String CountriesDockIn,
			String CurrentEmpWithinIndia, String Industry_Name, String Nature_OF_Work, String Provide_Details,
			String rickAssocite, String Provide_Details_1,

			// Contact Detail
			String address, String addressProof, String cityOfBirth, String insurance, String Account_Num,
			...
			// Nominee Detail
			String Nomine_FirstName, String Nomine_LastName, String Nominee_DOB, String Nominee_Gender,
			String Nominee_MobNum, String Nominee_Email, String Relationship, String sharePercent,
...
//		Lead Page 3
		...
		WebElement education = driver.findElement(By.xpath(
				"//select[@id='guideContainer-rootPanel-leadFormPanels-panel-panel1593077199576-panel-guidedropdownlist___widget']"));
...
//=================================================================  CREATE YOUR OWN PLAN  ===============================================================		
		...
		Library.Custom_SendKeys(ytp.getsum_assured(), Keys.CONTROL + "a", null);
		Library.Custom_SendKeys(ytp.getsum_assured(), sum, "Sum Assured " + sum);

		Thread.sleep(2000);
		WebElement policy = driver.findElement(By.xpath(
				"//select[@id='guideContainer-rootPanel-panel-panel1602840994127-panel-panel_2030159564-panel_776881033-panel1602832081639-guidedropdownlist_16___widget']"));
		...
		// ROP
		if (rop.equalsIgnoreCase("Y")) {
			Thread.sleep(2000);
			scroll.executeScript("window.scrollBy(0,100)", "");
			Library.Custom_Click(ytp.rop_Checked(), "Rop Select");
		} else if (rop.equalsIgnoreCase("N")) {
			// Nothing
		}
...
//================================================================ CHOOSE A PLAN OPTION ====================================================================
		...
		if (Payout_Type.equalsIgnoreCase("Monthly Income")) {
			Library.Custom_Click(ytp.monthlyIncome(), "Monthly Income ");
			scroll.executeScript("window.scrollBy(0,100)", "");

			Thread.sleep(2000);
			WebElement monthly = driver.findElement(By.xpath(
					"//select[@name='guideContainer-rootPanel-panel-panel1602840994127-panel-panel_1130119198-panel-guidedropdownlist_1075910158___jqName']"));
			Select monthIncome = new Select(monthly);
			monthIncome.selectByVisibleText(Monthly_Income);

		} else if (Payout_Type.equalsIgnoreCase("Part Lumpsum & Part Monthly Income")) {
			Library.Custom_Click(ytp.partLumpsumAndMonthlyIncome(), "Part Lumpsume & Part Monthly Income ");
			scroll.executeScript("window.scrollBy(0,500)", "");

			WebElement propotion = driver.findElement(By.xpath(
					"//select[@name='guideContainer-rootPanel-panel-panel1602840994127-panel-panel_1130119198-panel-guidedropdownlist___jqName']"));
			Select proportionList = new Select(propotion);
			// proportionList.selectByVisibleText(Proportion);

			Thread.sleep(2000);
			WebElement mio = driver.findElement(By.xpath(
					"//select[@name='guideContainer-rootPanel-panel-panel1602840994127-panel-panel_1130119198-panel-guidedropdownlist_1075910158___jqName']"));
...
//================================================================ CHOOSE ADDITIONAL BENEFITS [RIDERS] ====================================================================
		...
		if (ATPD_PPChecked.equalsIgnoreCase("Y") || ATPD_PPPChecked.equalsIgnoreCase("Y")
				|| TI_Checked.equalsIgnoreCase("Y")) {
...
//=================================================================   Proposal Form  ======================================================================
		...
		if (politically_Exposed_Person.equalsIgnoreCase("Y")) {
			...
			Library.Custom_SendKeys(ytp1.politicalExposed(), Person_Exposed_Politically,
					"Person_Exposed_Politically - " + Person_Exposed_Politically);
			Library.Custom_SendKeys(ytp1.relationshipWithPerson(), Relation_With_Person,
			...
			Library.Custom_SendKeys(ytp1.politicalPartyAsociated(), Name_Of_Political_Party,
					"Name_Of_Political_Party - " + Name_Of_Political_Party);
		...
		if (criminal_Charges.equalsIgnoreCase("Y")) {
			Library.Custom_Click(ytp1.criminal(), "Criminal Charges ");
			Library.Custom_SendKeys(ytp1.anyCriminalCase(), Any_Crminial_Case,
					"Any_Crminial_Case - " + Any_Crminial_Case);
		}
		...
		if (ageProof.equalsIgnoreCase("Valid Passport")) {
			...
			Library.Custom_SendKeys(ytp1.VDL_Exp_date(), VDL_Exp_date,
					"Valid Driving Licen Exp Date - " + VDL_Exp_date);
		}
		...
		if (IdProof.equalsIgnoreCase("Valid Passport")) {
			Library.Custom_SendKeys(ytp1.Id_num_for_id_proof(), VP_Id_Proof_Num,
					"VP ID Proof Number - " + VP_Id_Proof_Num);
			Library.Custom_SendKeys(ytp1.ExpDate(), VP_Id_Proof_Exp_Date,
					"VP ID Proof Exp Date - " + VP_Id_Proof_Exp_Date);
		} else if (IdProof.equalsIgnoreCase("Virtual Identification (VID)/ Aadhaar card")) {
			Library.Custom_SendKeys(ytp1.Id_num_for_id_proof(), VID_Id_Proof_4digit,
					"VID Four Digit Number - " + VID_Id_Proof_4digit);
...
//		Thread.sleep(3000);
//		Library.Custom_Click(ytp3.netBanking(), "Net Banking");
//		Thread.sleep(3000);
